...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images\anurag.jpg" alt="Anurag" width="400" height="240">
        <p><strong>Anurag Kumar</strong></p>
        <p>Anurag Kumar 3rd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images\abhishek.jpg" alt="Abhishek Verma" width="400" height="300">
        <p><strong>Abhishek Verma</strong></p>
        <p>Abhishek Verma 3rd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images\abh.jpg" alt="Anurag" width="400" height="240">
        <p><strong>Abhishek Rajput</strong></p>
        <p>Abhishek Rajput 3rd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images\aryan.jpg" alt="Aryan" width="400" height="240">
        <p><strong>Aryan Tomar</strong></p>
        <p>Aryan Tomar 3rd year BTECH</p>
      </div>
    </div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Abhishek Verma, Comment Box</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Anurag Kumar, Rep Inc</span></h4>
      </div>
      <!-- <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Abhishek Rajput </span></h4>
      </div> -->
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Ghaziabad, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 94******** </p>
      <p><span class="glyphicon glyphicon-envelope"></span> helponlineexam@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(28.7526051, 77.4958458);
